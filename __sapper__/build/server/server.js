...
<div class="${"home-container svelte-1c65kf4"}"><div><img class="${"main-logo svelte-1c65kf4"}" src="${"./images/logos/dwsdLogoColor.jpg"}" alt="${""}"></div>
  ...
  <div class="${"uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s\n    uk-margin uk-box-shadow-medium svelte-1c65kf4"}" uk-grid><div class="${"uk-card-media-left uk-cover-container"}"><img src="${"./images/farmingSmall.jpg"}" alt="${"Farming"}" uk-cover>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <a class="${"facebook-logo svelte-gulcyw"}" href="${"https://www.facebook.com/DucanWalkerSchenkerDaakePCLLO/"}" target="${"_blank"}" rel="${"noreferrer"}" title="${"Visit our Facebook page"}"><span uk-icon="${"icon: facebook"}"></span></a></nav>
