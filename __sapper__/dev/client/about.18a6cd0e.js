...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div1, file, 71, 8, 1525);
			attr_dev(a, "href", a_href_value = "mailto:" + /*email*/ ctx[3]);
			add_location(a, file, 75, 10, 1616);
			add_location(div2, file, 73, 8, 1583);
			attr_dev(div3, "class", "details svelte-zzybpe");
			add_location(div3, file, 70, 6, 1495);
			add_location(div4, file, 69, 4, 1483);
