...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			const card_changes = {};
			if (dirty & /*attorneys*/ 1) card_changes.name = /*attorney*/ ctx[3].name;
			if (dirty & /*attorneys*/ 1) card_changes.image = /*attorney*/ ctx[3].img;
			if (dirty & /*attorneys*/ 1) card_changes.phone = /*attorney*/ ctx[3].phone;
			if (dirty & /*attorneys*/ 1) card_changes.email = /*attorney*/ ctx[3].email;
			if (dirty & /*attorneys*/ 1) card_changes.bio = /*attorney*/ ctx[3].bio;
...
// (61:0) {#each attorney as attorneys}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(61:0) {#each attorney as attorneys}",
		ctx
	});
