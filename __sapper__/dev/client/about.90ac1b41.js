...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 66, 6, 1432);
			attr_dev(h4, "uk-target", h4_uk_target_value = "" + (/*name*/ ctx[0] + "Modal"));
			attr_dev(h4, "class", "svelte-1f51ddg");
			add_location(h4, file, 68, 8, 1540);
			attr_dev(div0, "class", "uk-overlay uk-overlay-primary uk-position-bottom svelte-1f51ddg");
			add_location(div0, file, 67, 6, 1469);
			attr_dev(header, "class", "image uk-inline svelte-1f51ddg");
			add_location(header, file, 65, 4, 1393);
			add_location(div1, file, 73, 8, 1653);
			attr_dev(a, "href", a_href_value = "mailto:" + /*email*/ ctx[3]);
			add_location(a, file, 77, 10, 1744);
			add_location(div2, file, 75, 8, 1711);
			attr_dev(div3, "class", "details svelte-1f51ddg");
			add_location(div3, file, 72, 6, 1623);
			add_location(div4, file, 71, 4, 1611);
			attr_dev(div5, "class", "card-container uk-box-shadow-bottom uk-box-shadow-small svelte-1f51ddg");
