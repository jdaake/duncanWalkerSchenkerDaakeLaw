...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-1ke0jn4");
			add_location(h2, file$1, 40, 2, 877);
			attr_dev(p, "class", "svelte-1ke0jn4");
			add_location(p, file$1, 41, 2, 920);
			attr_dev(div, "class", "header-container svelte-1ke0jn4");
			add_location(div, file$1, 39, 0, 804);
			attr_dev(section, "class", "svelte-1ke0jn4");
