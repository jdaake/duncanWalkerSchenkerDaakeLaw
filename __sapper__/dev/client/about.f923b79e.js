...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			h4 = claim_element(div0_nodes, "H4", { "uk-toggle": true, class: true });
		...
		h: function hydrate() {
			...
			attr_dev(h4, "uk-toggle", h4_uk_toggle_value = "target: #" + /*name*/ ctx[0] + "Modal");
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*name*/ 1 && h4_uk_toggle_value !== (h4_uk_toggle_value = "target: #" + /*name*/ ctx[0] + "Modal")) {
				attr_dev(h4, "uk-toggle", h4_uk_toggle_value);
			}
