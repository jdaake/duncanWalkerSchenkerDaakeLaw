...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "main-logo svelte-1tvw7qg");
			...
			attr_dev(h3, "class", "uk-card-title svelte-1tvw7qg");
			add_location(h3, file, 82, 8, 1722);
			attr_dev(p0, "class", "svelte-1tvw7qg");
			add_location(p0, file, 83, 8, 1774);
			attr_dev(p1, "class", "svelte-1tvw7qg");
			add_location(p1, file, 89, 8, 2086);
			attr_dev(p2, "class", "svelte-1tvw7qg");
