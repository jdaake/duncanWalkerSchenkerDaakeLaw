...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(canvas, file, 77, 6, 1602);
			...
			add_location(h3, file, 81, 8, 1700);
			attr_dev(p0, "class", "svelte-mj206k");
			add_location(p0, file, 82, 8, 1752);
			attr_dev(p1, "class", "svelte-mj206k");
			add_location(p1, file, 88, 8, 2064);
			attr_dev(p2, "class", "svelte-mj206k");
			add_location(p2, file, 95, 8, 2434);
			attr_dev(div2, "class", "uk-card-body");
			add_location(div2, file, 80, 6, 1665);
			add_location(div3, file, 79, 4, 1653);
