...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 52, 10, 1247);
			add_location(li1, file, 53, 10, 1283);
			add_location(li2, file, 54, 10, 1315);
			add_location(li3, file, 55, 10, 1345);
			add_location(li4, file, 56, 10, 1381);
			add_location(li5, file, 57, 10, 1416);
			add_location(li6, file, 58, 10, 1447);
			add_location(ul, file, 51, 8, 1232);
