...
import { F as Footer } from './footer.c707f36d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 49, 6, 1073);
			attr_dev(canvas, "width", "400");
			attr_dev(canvas, "height", "300");
			add_location(canvas, file, 50, 6, 1142);
			attr_dev(div0, "class", "uk-card-media-left uk-cover-container");
			add_location(div0, file, 48, 4, 1015);
			attr_dev(h3, "class", "uk-card-title svelte-oaeiz5");
			add_location(h3, file, 54, 8, 1240);
			add_location(li0, file, 56, 10, 1307);
			add_location(li1, file, 57, 10, 1343);
			add_location(li2, file, 58, 10, 1375);
			add_location(li3, file, 59, 10, 1405);
			add_location(li4, file, 60, 10, 1441);
			add_location(li5, file, 61, 10, 1476);
			add_location(li6, file, 62, 10, 1507);
			add_location(ul, file, 55, 8, 1292);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 53, 6, 1205);
			add_location(div2, file, 52, 4, 1193);
			...
			add_location(div3, file, 44, 2, 884);
			attr_dev(div4, "class", "practice-container svelte-oaeiz5");
			add_location(div4, file, 41, 0, 790);
		},
