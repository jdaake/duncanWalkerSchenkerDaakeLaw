...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(canvas, file, 46, 6, 1086);
			attr_dev(div0, "class", "uk-card-media-left uk-cover-container");
			add_location(div0, file, 44, 4, 955);
			attr_dev(h3, "class", "uk-card-title");
			add_location(h3, file, 50, 8, 1184);
			add_location(li0, file, 53, 10, 1252);
			add_location(li1, file, 54, 10, 1288);
			add_location(li2, file, 55, 10, 1320);
			add_location(li3, file, 56, 10, 1350);
			add_location(li4, file, 57, 10, 1386);
			add_location(li5, file, 58, 10, 1421);
			add_location(li6, file, 59, 10, 1452);
			add_location(ul, file, 52, 8, 1237);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 49, 6, 1149);
			add_location(div2, file, 48, 4, 1137);
