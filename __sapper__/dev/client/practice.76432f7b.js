...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 55, 6, 1138);
			attr_dev(canvas, "width", "500");
			attr_dev(canvas, "height", "500");
			add_location(canvas, file, 56, 6, 1207);
			attr_dev(div0, "class", "uk-card-media-left uk-cover-container");
			add_location(div0, file, 54, 4, 1080);
			attr_dev(h3, "class", "uk-card-title svelte-6zxtwn");
			add_location(h3, file, 60, 8, 1305);
			attr_dev(p, "class", "svelte-6zxtwn");
			add_location(p, file, 61, 8, 1362);
			attr_dev(li0, "class", "svelte-6zxtwn");
			add_location(li0, file, 66, 10, 1520);
			attr_dev(li1, "class", "svelte-6zxtwn");
			add_location(li1, file, 67, 10, 1556);
			attr_dev(li2, "class", "svelte-6zxtwn");
			add_location(li2, file, 68, 10, 1588);
			attr_dev(li3, "class", "svelte-6zxtwn");
			add_location(li3, file, 69, 10, 1618);
			attr_dev(li4, "class", "svelte-6zxtwn");
			add_location(li4, file, 70, 10, 1654);
			attr_dev(li5, "class", "svelte-6zxtwn");
			add_location(li5, file, 71, 10, 1689);
			attr_dev(li6, "class", "svelte-6zxtwn");
			add_location(li6, file, 72, 10, 1720);
			add_location(ul, file, 65, 8, 1505);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 59, 6, 1270);
			add_location(div2, file, 58, 4, 1258);
			...
			add_location(div3, file, 50, 2, 949);
			attr_dev(div4, "class", "practice-container svelte-6zxtwn");
			add_location(div4, file, 47, 0, 855);
		},
