...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 61, 10, 1477);
			attr_dev(li1, "class", "svelte-usxlsq");
			add_location(li1, file, 62, 10, 1513);
			attr_dev(li2, "class", "svelte-usxlsq");
			add_location(li2, file, 63, 10, 1545);
			attr_dev(li3, "class", "svelte-usxlsq");
			add_location(li3, file, 64, 10, 1575);
			attr_dev(li4, "class", "svelte-usxlsq");
			add_location(li4, file, 65, 10, 1611);
			attr_dev(li5, "class", "svelte-usxlsq");
			add_location(li5, file, 66, 10, 1646);
			attr_dev(li6, "class", "svelte-usxlsq");
			add_location(li6, file, 67, 10, 1677);
			add_location(ul, file, 60, 8, 1462);
