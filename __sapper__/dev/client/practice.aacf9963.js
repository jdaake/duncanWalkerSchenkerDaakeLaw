...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 51, 6, 1100);
			attr_dev(canvas, "width", "500");
			attr_dev(canvas, "height", "500");
			add_location(canvas, file, 52, 6, 1169);
			attr_dev(div0, "class", "uk-card-media-left uk-cover-container");
			add_location(div0, file, 50, 4, 1042);
			attr_dev(h3, "class", "uk-card-title svelte-ii50a4");
			add_location(h3, file, 56, 8, 1267);
			attr_dev(p, "class", "svelte-ii50a4");
			add_location(p, file, 57, 8, 1324);
			attr_dev(li0, "class", "svelte-ii50a4");
			add_location(li0, file, 62, 10, 1482);
			attr_dev(li1, "class", "svelte-ii50a4");
			add_location(li1, file, 63, 10, 1518);
			attr_dev(li2, "class", "svelte-ii50a4");
			add_location(li2, file, 64, 10, 1550);
			attr_dev(li3, "class", "svelte-ii50a4");
			add_location(li3, file, 65, 10, 1580);
			attr_dev(li4, "class", "svelte-ii50a4");
			add_location(li4, file, 66, 10, 1616);
			attr_dev(li5, "class", "svelte-ii50a4");
			add_location(li5, file, 67, 10, 1651);
			attr_dev(li6, "class", "svelte-ii50a4");
			add_location(li6, file, 68, 10, 1682);
			add_location(ul, file, 61, 8, 1467);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 55, 6, 1232);
			add_location(div2, file, 54, 4, 1220);
			...
			add_location(div3, file, 46, 2, 911);
			attr_dev(div4, "class", "practice-container svelte-ii50a4");
			add_location(div4, file, 43, 0, 817);
		},
