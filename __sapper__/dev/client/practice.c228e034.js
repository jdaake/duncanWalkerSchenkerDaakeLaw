...
import { F as Footer } from './footer.18baf35b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "main-logo svelte-lh149h");
			if (img0.src !== (img0_src_value = "./images/logos/dwsdLogoColor.jpg")) attr_dev(img0, "src", img0_src_value);
			attr_dev(img0, "alt", "");
			add_location(img0, file, 53, 4, 1003);
			add_location(div0, file, 52, 2, 993);
			...
			add_location(img1, file, 61, 6, 1293);
			attr_dev(canvas, "width", "500");
			attr_dev(canvas, "height", "400");
			add_location(canvas, file, 62, 6, 1366);
			attr_dev(div1, "class", "uk-card-media-left uk-cover-container");
			add_location(div1, file, 60, 4, 1235);
			attr_dev(h3, "class", "uk-card-title svelte-lh149h");
			add_location(h3, file, 66, 8, 1464);
			attr_dev(p, "class", "svelte-lh149h");
			add_location(p, file, 67, 8, 1521);
			attr_dev(li0, "class", "svelte-lh149h");
			add_location(li0, file, 69, 10, 1608);
			attr_dev(li1, "class", "svelte-lh149h");
			add_location(li1, file, 70, 10, 1644);
			attr_dev(li2, "class", "svelte-lh149h");
			add_location(li2, file, 71, 10, 1676);
			attr_dev(li3, "class", "svelte-lh149h");
			add_location(li3, file, 72, 10, 1706);
			attr_dev(li4, "class", "svelte-lh149h");
			add_location(li4, file, 73, 10, 1742);
			attr_dev(li5, "class", "svelte-lh149h");
			add_location(li5, file, 74, 10, 1777);
			attr_dev(li6, "class", "svelte-lh149h");
			add_location(li6, file, 75, 10, 1808);
			add_location(ul, file, 68, 8, 1593);
			attr_dev(div2, "class", "uk-card-body");
			add_location(div2, file, 65, 6, 1429);
			add_location(div3, file, 64, 4, 1417);
			...
			add_location(div4, file, 56, 2, 1104);
			attr_dev(div5, "class", "practice-container svelte-lh149h");
			add_location(div5, file, 51, 0, 918);
		},
