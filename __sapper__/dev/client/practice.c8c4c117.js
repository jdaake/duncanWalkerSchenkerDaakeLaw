...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(canvas, file, 53, 6, 1174);
			...
			add_location(h3, file, 57, 8, 1272);
			attr_dev(p, "class", "svelte-4pre94");
			add_location(p, file, 58, 8, 1329);
			attr_dev(li0, "class", "svelte-4pre94");
			add_location(li0, file, 60, 10, 1416);
			attr_dev(li1, "class", "svelte-4pre94");
			add_location(li1, file, 61, 10, 1452);
			attr_dev(li2, "class", "svelte-4pre94");
			add_location(li2, file, 62, 10, 1484);
			attr_dev(li3, "class", "svelte-4pre94");
			add_location(li3, file, 63, 10, 1514);
			attr_dev(li4, "class", "svelte-4pre94");
			add_location(li4, file, 64, 10, 1550);
			attr_dev(li5, "class", "svelte-4pre94");
			add_location(li5, file, 65, 10, 1585);
			attr_dev(li6, "class", "svelte-4pre94");
			add_location(li6, file, 66, 10, 1616);
			add_location(ul, file, 59, 8, 1401);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 56, 6, 1237);
			add_location(div2, file, 55, 4, 1225);
