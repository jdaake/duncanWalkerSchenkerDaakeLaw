...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 63, 10, 1445);
			attr_dev(li1, "class", "svelte-dswjt4");
			add_location(li1, file, 64, 10, 1481);
			attr_dev(li2, "class", "svelte-dswjt4");
			add_location(li2, file, 65, 10, 1513);
			attr_dev(li3, "class", "svelte-dswjt4");
			add_location(li3, file, 66, 10, 1543);
			attr_dev(li4, "class", "svelte-dswjt4");
			add_location(li4, file, 67, 10, 1579);
			attr_dev(li5, "class", "svelte-dswjt4");
			add_location(li5, file, 68, 10, 1614);
			attr_dev(li6, "class", "svelte-dswjt4");
			add_location(li6, file, 69, 10, 1645);
			add_location(ul, file, 62, 8, 1430);
