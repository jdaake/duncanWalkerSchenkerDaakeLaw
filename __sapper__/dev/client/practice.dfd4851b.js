...
import { F as Footer } from './footer.6b97b37b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h3, "class", "uk-card-title svelte-r8y7lg");
			add_location(h3, file, 58, 8, 1298);
			attr_dev(p, "class", "svelte-r8y7lg");
			add_location(p, file, 59, 8, 1355);
			attr_dev(li0, "class", "svelte-r8y7lg");
			add_location(li0, file, 61, 10, 1442);
			attr_dev(li1, "class", "svelte-r8y7lg");
			add_location(li1, file, 62, 10, 1478);
			attr_dev(li2, "class", "svelte-r8y7lg");
			add_location(li2, file, 63, 10, 1510);
			attr_dev(li3, "class", "svelte-r8y7lg");
			add_location(li3, file, 64, 10, 1540);
			attr_dev(li4, "class", "svelte-r8y7lg");
			add_location(li4, file, 65, 10, 1576);
			attr_dev(li5, "class", "svelte-r8y7lg");
			add_location(li5, file, 66, 10, 1611);
			attr_dev(li6, "class", "svelte-r8y7lg");
			...
			attr_dev(div4, "class", "practice-container svelte-r8y7lg");
