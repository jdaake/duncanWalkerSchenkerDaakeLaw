...
import { F as Footer } from './footer.cad37a16.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h3, "class", "uk-card-title svelte-17g3zqo");
			add_location(h3, file, 60, 8, 1305);
			attr_dev(p, "class", "svelte-17g3zqo");
			add_location(p, file, 61, 8, 1362);
			attr_dev(li0, "class", "svelte-17g3zqo");
			add_location(li0, file, 66, 10, 1520);
			attr_dev(li1, "class", "svelte-17g3zqo");
			add_location(li1, file, 67, 10, 1556);
			attr_dev(li2, "class", "svelte-17g3zqo");
			add_location(li2, file, 68, 10, 1588);
			attr_dev(li3, "class", "svelte-17g3zqo");
			add_location(li3, file, 69, 10, 1618);
			attr_dev(li4, "class", "svelte-17g3zqo");
			add_location(li4, file, 70, 10, 1654);
			attr_dev(li5, "class", "svelte-17g3zqo");
			add_location(li5, file, 71, 10, 1689);
			attr_dev(li6, "class", "svelte-17g3zqo");
			...
			attr_dev(div4, "class", "practice-container svelte-17g3zqo");
