...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 55, 6, 1150);
			attr_dev(canvas, "width", "500");
			attr_dev(canvas, "height", "500");
			add_location(canvas, file, 56, 6, 1219);
			attr_dev(div0, "class", "uk-card-media-left uk-cover-container");
			add_location(div0, file, 54, 4, 1092);
			attr_dev(h3, "class", "uk-card-title svelte-15d3itt");
			add_location(h3, file, 60, 8, 1317);
			attr_dev(p, "class", "svelte-15d3itt");
			add_location(p, file, 61, 8, 1374);
			attr_dev(li0, "class", "svelte-15d3itt");
			add_location(li0, file, 66, 10, 1532);
			attr_dev(li1, "class", "svelte-15d3itt");
			add_location(li1, file, 67, 10, 1568);
			attr_dev(li2, "class", "svelte-15d3itt");
			add_location(li2, file, 68, 10, 1600);
			attr_dev(li3, "class", "svelte-15d3itt");
			add_location(li3, file, 69, 10, 1630);
			attr_dev(li4, "class", "svelte-15d3itt");
			add_location(li4, file, 70, 10, 1666);
			attr_dev(li5, "class", "svelte-15d3itt");
			add_location(li5, file, 71, 10, 1701);
			attr_dev(li6, "class", "svelte-15d3itt");
			add_location(li6, file, 72, 10, 1732);
			add_location(ul, file, 65, 8, 1517);
			attr_dev(div1, "class", "uk-card-body");
			add_location(div1, file, 59, 6, 1282);
			add_location(div2, file, 58, 4, 1270);
			...
			add_location(div3, file, 50, 2, 961);
			attr_dev(div4, "class", "practice-container svelte-15d3itt");
			add_location(div4, file, 47, 0, 867);
		},
